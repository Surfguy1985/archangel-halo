        ...
        <header className="flex items-center gap-[10px] px-[18px] pt-[16px] pb-[12px] shrink-0">
          ...
          >
            ...
            {today?.unreadNotifications ? (
              <span className="absolute -top-[2px] -right-[2px] min-w-[18px] h-[18px] px-[5px] rounded-[9px] bg-destructive text-white text-[11px] font-bold grid place-items-center font-display">
                {today.unreadNotifications}
              </span>
            ) : null}
          </button>
