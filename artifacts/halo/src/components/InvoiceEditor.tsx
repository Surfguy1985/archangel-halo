    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="p-[8px_20px_26px] overflow-y-auto">
          ...
          <button
            className="w-full mt-[18px] rounded-full py-[15px] font-display font-bold text-[16px] text-[var(--ink)] bg-[linear-gradient(135deg,var(--gold-light),var(--gold),var(--gold-dark))] shadow-[0_6px_20px_rgba(143,106,31,0.34)] disabled:opacity-40 transition-transform active:scale-[0.98]"
            onClick={submit}
            disabled={!canSubmit}
          >
            {pending
