...
export function ProposalCard({
  ...
  if (state === "approved" || state === "dismissed") {
    return (
      <div
        className="mt-[10px] ml-[13px] flex items-center gap-2 text-[11.5px]"
  ...
  return (
    <div
      className="mt-[11px] ml-[13px] rounded-[12px] p-[11px]"
      style={{
    ...
    >
      <div className="flex items-start gap-[9px]">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[13px] leading-[1.5]" style={{ color: "rgba(255,255,255,0.86)" }}>
            {proposal.decision}
          </p>
          <p className="text-[11px] leading-[1.45] mt-[3px]" style={{ color: "rgba(255,255,255,0.4)" }}>
            {proposal.body}
          </p>
        </div>
      </div>
      ...
      <div className="flex gap-[7px] mt-[10px]">
        <button
          ...
          onClick={onApprove}
          disabled={busy}
          className="flex-1 flex items-center justify-center gap-[5px] text-[12px] font-semibold py-[7px] rounded-[8px] transition-all active:scale-[0.98] disabled:opacity-50"
        ...
        <button
          ...
          onClick={onDismiss}
          disabled={busy}
          className="px-[13px] text-[12px] font-medium py-[7px] rounded-[8px] transition-all active:scale-[0.98] disabled:opacity-50"
          style={{
