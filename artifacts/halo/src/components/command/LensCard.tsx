    ...
    <div className="space-y-3">
      ...
      {unpaid.length > 0 ? (
        <div className="space-y-1.5">
          <div className="text-[10px] font-bold tracking-[0.15em] uppercase text-white/35 px-1">
          ...
          {unpaid.slice(0, 4).map(inv => {
            ...
            return (
              <div
                ...
                className="flex items-center gap-3 bg-white/5 hover:bg-white/8 rounded-[12px] px-3 py-2.5 cursor-pointer transition-colors active:scale-[0.98]"
              >
          ...
          {unpaid.length > 4 && (
            <button
              ...
              className="w-full text-center text-[11px] text-white/40 hover:text-white/60 py-1 transition-colors"
            >
        ...
        <div className="flex items-center gap-2 bg-[#22C55E]/10 rounded-[12px] px-3 py-2.5">
          ...
          <span className="text-[12.5px] text-[#22C55E]/90">All invoices are current. No outstanding balances.</span>
        </div>
      )}
...
function TimelineLens({ query }: { query?: string }) {
  ...
  return (
    <div className="space-y-3">
      ...
      {overdue.length > 0 && (
        <div className="space-y-1.5">
          <div className="text-[10px] font-bold tracking-[0.15em] uppercase text-[#E11D48]/80 px-1">
            Overdue
          </div>
    ...
    <div className="space-y-3">
      <div className="flex items-center gap-2 bg-white/4 rounded-[12px] px-3 py-2.5">
        ...
        <span className="text-[12.5px] text-white/70">
          Live GPS map available in Crew Command Center
        </span>
      ...
      {recent.length > 0 ? (
        <>
          ...
          <div className="text-center text-[11px] text-white/35">
            Tap a job to view photos · {jobsWithPhotos.length} jobs with evidence
          </div>
        </>
      ) : (
