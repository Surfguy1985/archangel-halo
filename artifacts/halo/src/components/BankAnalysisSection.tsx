    ...
    <div className="flex flex-col gap-[10px]">
      <div className="flex items-center gap-[8px] mt-[4px]">
        ...
        <button
          ...
          className="shrink-0 inline-flex items-center gap-[5px] rounded-[10px] px-[10px] py-[7px] text-[12px] font-display font-bold bg-[var(--ink)] text-[var(--paper,#f5f1e8)] shadow-[var(--shadow)] disabled:opacity-40 transition-transform active:scale-[0.98]"
        >
          <CopyPlus
            className={`w-[13px] h-[13px] ${apply.isPending ? "animate-pulse" : ""}`}
          />
