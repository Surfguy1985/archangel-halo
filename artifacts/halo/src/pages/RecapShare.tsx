  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="px-[14px] py-[16px] pb-[44px] max-w-[720px] mx-auto flex-1 w-full">
        <div className="bg-card rounded-[16px] border border-border border-t-[3px] border-t-primary shadow-[0_0_20px_rgba(198,242,17,0.05)] p-[18px] mb-[14px]">
          <div className="flex items-center gap-[7px] text-[12px] font-semibold text-primary mb-[10px]">
            <CheckCircle2 className="w-[15px] h-[15px] drop-shadow-[0_0_5px_rgba(198,242,17,0.5)]" />
            Work completed
        ...
        <div className="bg-card border border-border rounded-[16px] p-[15px] mb-[14px]">
          <div className="font-display font-bold text-[11px] tracking-[0.14em] uppercase text-primary drop-shadow-[0_0_5px_rgba(198,242,17,0.3)] mb-[12px]">
            Job details
          </div>
