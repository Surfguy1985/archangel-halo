# Consuming HALO Design System in Expo apps

Read `artifacts/halo-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/halo-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/halo-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/halo-ds/lib/native-theme";
import { useColors } from "@workspace/halo-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/halo-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/halo-ds/components/native/badge";
import { Button } from "@workspace/halo-ds/components/native/button";
import { Card } from "@workspace/halo-ds/components/native/card";
```
...
Import and render
`@workspace/halo-ds/components/native/button`, then run Expo
