# Migrating web UI to HALO Design System

Read `artifacts/halo-ds/docs/AGENTS.md` and
`artifacts/halo-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/halo-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/halo-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/halo-ds/hooks/use-toast`
