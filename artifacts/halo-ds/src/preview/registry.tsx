...
import { BrandLogoPage } from './brand-logo';
...
export const DESIGN_SYSTEM = {
  ...
  description:
    'Dark-navy + lime (#B4FF44) visual language for HALO — Archangel Operations. Used by the office app, crew portal, client dashboard, and walk apps.',
} as const;

export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Overview',
  description: 'Core palette, typography, and in-use components at a glance.',
  Page: OverviewPage,
};
    ...
    entries: [
      {
        id: 'brand-logo',
        name: 'Logo',
        description: 'The HALO mark, brand colours, clear space, and sizing rules.',
        Page: BrandLogoPage,
      },
    ],
  },
