...
import siteOpsBotRouter from "./siteOpsBot";
import vapiFieldVerifyRouter from "./vapiFieldVerify";
import osmBuildingsRouter from "./osmBuildings";
import siteSelectionRouter from "./siteSelection";
...
import buildingOpsRouter from "./buildingOps";
import unityTwinRouter from "./unityTwin";
...
router.use(siteOpsBotRouter);
router.use(vapiFieldVerifyRouter);
router.use(osmBuildingsRouter);
router.use(siteSelectionRouter);
router.use(invoiceDraftsRouter);
router.use(pulseHomeRouter);
router.use(portfolioHomeRouter);
router.use(opsRouter);
router.use(buildingOpsRouter);
router.use(unityTwinRouter);
