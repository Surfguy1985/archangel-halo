...
export const HALO_CAPABILITIES = [
  ...
  "invoices.read",
  "invoices.send",
  // Editing a line price or a crew payout after the fact is its own grant:
  // being allowed to send an invoice is not the same as being allowed to
  // change what it says.
  "invoices.adjust",
  "payouts.adjust",
  "pricing.write",
...
const ACTION_TO_CAPABILITY: Record<string, HaloCapability> = {
  ...
  "invoice.line.adjust": "invoices.adjust",
  "invoice.adjust": "invoices.adjust",
  "crew.payout.adjust": "payouts.adjust",
  "payout.adjust": "payouts.adjust",
