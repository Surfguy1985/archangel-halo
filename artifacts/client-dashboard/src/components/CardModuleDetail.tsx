import { ExternalLink, CheckCircle2, Circle, FileText, Check, Users, Receipt, List, MapPin } from 'lucide-react';
import { formatDistanceToNow, parseISO } from 'date-fns';
import { useState } from 'react';
import { PdfViewerDialog } from './PdfViewerDialog';
import { BirdseyeMapDialog } from './BirdseyeMapDialog';

export function CardModuleDetail({ module, token }: { module: any; token: string }) {
  ...
  return (
    <div className="flex flex-col gap-6 py-4">
      {/* SUMMARY */}
      {module.type === 'summary' && module.taskSections && module.taskSections.length > 0 && (
