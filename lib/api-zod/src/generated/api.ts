 ...
 */
export const GetJobComplianceParams = zod.object({
  "id": zod.coerce.string()
})

export const GetJobComplianceResponse = zod.object({
  "jobId": zod.string(),
  ...
  "beforePhotos": zod.number(),
  "afterPhotos": zod.number(),
  "acknowledged": zod.boolean(),
  "acknowledgedAt": zod.string().nullish(),
  "acknowledgedVia": zod.string().nullish(),
  "needsReview": zod.boolean(),
  "missing": zod.array(zod.string()).describe('Human-readable list of what is missing, e.g. \'check-out\', \'after photos\'')
}).describe('Whether a crew met the acknowledged requirements on a job — used by the office to decide whether pay needs supervisor review.'))
})
...
export const CreateCrewBody = zod.object({
  "name": zod.string().min(1),
  "trade": zod.string().optional(),
  "company": zod.string().nullish().describe('Subcontractor company. Null\/empty = in-house crew'),
  "phone": zod.string().optional(),
  "email": zod.string().optional(),
...
export const CreateCrewResponse = zod.object({
  ...
  "name": zod.string(),
  "trade": zod.string().nullish(),
  "company": zod.string().nullish().describe('Subcontractor company. Null = in-house crew'),
  "phone": zod.string().nullish(),
  "email": zod.string().nullish(),
  "isLeader": zod.boolean().nullish(),
...
export const GetBusinessSettingsResponse = zod.object({
  ...
  "emailDailyDigest": zod.boolean().optional().describe('Send the 6:45am scheduled daily task-list digest to the owner'),
  "emailEveningClose": zod.boolean().optional().describe('Send the 6:30pm scheduled evening close summary to the owner'),
  "emailLeadNurtureDrip": zod.boolean().optional().describe('Run automated lead nurture drip campaign steps'),
  "emailAutoJobRecapLinks": zod.boolean().optional().describe('Auto-send live job link \/ recap email when a job is scheduled or completed'),
  "emailCrewThankYou": zod.boolean().optional().describe('Send crew a thank-you email on job close-out'),
  "emailInquiryAutoReply": zod.boolean().optional().describe('Auto-reply thank-you to new phone-in inquiries')
})
...
export const UpdateBusinessSettingsBody = zod.object({
  ...
  "emailDailyDigest": zod.boolean().optional(),
  "emailEveningClose": zod.boolean().optional(),
  "emailLeadNurtureDrip": zod.boolean().optional(),
  "emailAutoJobRecapLinks": zod.boolean().optional(),
  "emailCrewThankYou": zod.boolean().optional(),
  "emailInquiryAutoReply": zod.boolean().optional()
})
...
/**
 * @summary List this vendor's per-service rates alongside the master price
 */
export const ListVendorRatesParams = zod.object({
  "id": zod.coerce.string()
})

export const ListVendorRatesResponseItem = zod.object({
  "id": zod.string(),
  "vendorId": zod.string(),
...
export const ListVendorRatesResponse = zod.array(ListVendorRatesResponseItem)


/**
 * @summary Set this vendor's rate for a catalog service
 */
export const UpsertVendorRateParams = zod.object({
  "id": zod.coerce.string(),
  "catalogItemId": zod.coerce.string()
})

export const UpsertVendorRateBody = zod.object({
  "rate": zod.number()
})

export const UpsertVendorRateResponse = zod.object({
  "id": zod.string(),
  "vendorId": zod.string(),
  "catalogItemId": zod.string(),
  "service": zod.string(),
...
/**
 * @summary Remove this vendor's rate for a catalog service
 */
export const DeleteVendorRateParams = zod.object({
  "id": zod.coerce.string(),
  "catalogItemId": zod.coerce.string()
})

export const DeleteVendorRateResponse = zod.object({
  "vendorId": zod.string(),
  "catalogItemId": zod.string()
})
...
export const GetCrewDetailResponse = zod.object({
  ...
  "instructionsAck": zod.union([zod.object({
  "accepted": zod.boolean().describe('True when a non-expired acceptance is on record'),
  "agreedAt": zod.string().nullish(),
  "linkKind": zod.string().nullish().describe('paycard | portal | join | app'),
  "lang": zod.string().nullish(),
  "version": zod.string().nullish(),
  "termsText": zod.string().nullish().describe('Snapshot of the wording the crew agreed to'),
  "expiresAt": zod.string().nullish()
}).describe('Most recent acceptance of the crew-link instructions gate, with the exact wording that was shown, so pay disputes can cite it.'),zod.null()]).optional()
})
